...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM portfolio_profiles) THEN
        ...
        INSERT INTO portfolio_experiences (profile_id, title, location, period, position) VALUES
        (v_profile_id, 'Founder & Infrastructure Engineer — Singularity Works', 'Remote (India)', 'August 25'' –Present', 0),
        (v_profile_id, 'Full Stack Developer Intern — amasQIS.ai', 'Remote (Muscat, Oman)', 'April 25''–November 25''', 1),
        (v_profile_id, 'President — Mozilla Firefox Club (VIT)', 'University (VIT)', 'June 25''–February 26''', 2),
        (v_profile_id, 'Operations Manager — AI Club (VIT)', 'University (VIT)', 'June 25''–January 26''', 3),
        (v_profile_id, 'Frontend Developer — Operation Smile Foundation (NGO,Non-profit)', 'Remote (India)', 'April 24''–June 24''', 4);
